...
const About = () => {
    ...
    return (
        <section id="about" className="py-16 bg-gray-900 overflow-hidden relative">
            <Container className="relative z-10">
                ...
                >
                    ...
                    <div className={`grid ${isDesktop ? 'lg:grid-cols-5' : 'grid-cols-1'} gap-6`}>
                        ...
                        <motion.div
                            variants={fadeInUp}
                            className={`bg-gray-800 rounded-xl p-6 md:p-8 shadow-md ${isDesktop ? 'lg:col-span-3' : ''}`}
                        >
                            <div className="space-y-6">
                                {/* Encabezado con símbolos de código */}
                                <div className="flex items-center space-x-2 text-slate-500 font-mono text-sm pb-2 border-b border-slate-700">
                                    <span>&lt;Perfil</span>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="relative pl-4 border-l-2 border-indigo-400 italic text-gray-400">
                                ...
                                <div className="grid md:grid-cols-3 gap-4">
                                    <div className="relative group overflow-hidden rounded-lg">
                                        ...
                                        <div className="bg-gray-800/80 group-hover:bg-transparent p-4 rounded-lg relative z-10 h-full border border-indigo-900/50 transition-colors duration-300">
                                            <div className="flex items-center mb-3">
                                                <div className="p-1.5 rounded-full bg-blue-900/50 group-hover:bg-white/20 transition-colors duration-300">
                                                    <Code className="text-blue-400 group-hover:text-white h-5 w-5 transition-colors duration-300" />
                                                </div>
                                                <h4 className="ml-2 font-medium text-gray-200 group-hover:text-white transition-colors duration-300">Frontend</h4>
                                            </div>
                                            <p className="text-sm text-gray-400 group-hover:text-white/90 transition-colors duration-300">
                                    ...
                                    <div className="relative group overflow-hidden rounded-lg">
                                        ...
                                        <div className="bg-gray-800/80 group-hover:bg-transparent p-4 rounded-lg relative z-10 h-full border border-blue-900/50 transition-colors duration-300">
                                            <div className="flex items-center mb-3">
                                                <div className="p-1.5 rounded-full bg-cyan-900/50 group-hover:bg-white/20 transition-colors duration-300">
                                                    <HardDrive className="text-cyan-400 group-hover:text-white h-5 w-5 transition-colors duration-300" />
                                                </div>
                                                <h4 className="ml-2 font-medium text-gray-200 group-hover:text-white transition-colors duration-300">Backend</h4>
                                            </div>
                                            <p className="text-sm text-gray-400 group-hover:text-white/90 transition-colors duration-300">
                                    ...
                                    <div className="relative group overflow-hidden rounded-lg">
                                        ...
                                        <div className="bg-gray-800/80 group-hover:bg-transparent p-4 rounded-lg relative z-10 h-full border border-teal-900/50 transition-colors duration-300">
                                            <div className="flex items-center mb-3">
                                                <div className="p-1.5 rounded-full bg-teal-900/50 group-hover:bg-white/20 transition-colors duration-300">
                                                    <Rocket className="text-teal-400 group-hover:text-white h-5 w-5 transition-colors duration-300" />
                                                </div>
                                                <h4 className="ml-2 font-medium text-gray-200 group-hover:text-white transition-colors duration-300">Metodologías</h4>
                                            </div>
                                            <p className="text-sm text-gray-400 group-hover:text-white/90 transition-colors duration-300">
                        ...
                        {isDesktop ? (
                            <motion.div
                                variants={fadeInUp}
                                className="bg-gray-800 rounded-xl p-6 md:p-8 shadow-md lg:col-span-2 relative self-center"
                            >
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-start">
                                                <div className="p-1.5 rounded-full bg-indigo-900/30 mr-3 mt-0.5">
                                                    <Layers className="text-indigo-400 h-4 w-4" />
                                                </div>
                                                <div>
                                                    <h4 className="font-medium text-gray-200 text-sm">Sistemas Técnicos</h4>
                                            ...
                                            <div className="flex items-start">
                                                <div className="p-1.5 rounded-full bg-cyan-900/30 mr-3 mt-0.5">
                                                    <BookOpen className="text-cyan-400 h-4 w-4" />
                                                </div>
                                                <div>
                                                    <h4 className="font-medium text-gray-200 text-sm">Gestión de Almacén</h4>
                                                    <p className="text-xs text-gray-400 mt-1">
                                            ...
                                            <div className="flex items-start">
                                                <div className="p-1.5 rounded-full bg-teal-900/30 mr-3 mt-0.5">
                                                    <Cpu className="text-teal-400 h-4 w-4" />
                                                </div>
                                                <div>
                                                    <h4 className="font-medium text-gray-200 text-sm">Electricidad</h4>
                                                    <p className="text-xs text-gray-400 mt-1">
                                    ...
                                    <div className="pt-4 border-t border-gray-700">
                                        <motion.button
                                            ...
                                            className="w-full bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-700 hover:to-gray-600 text-white rounded-lg py-2 px-4 text-sm font-medium shadow-inner flex items-center justify-center"
                ...
                {isDesktop && isBackgroundVisible && (
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-gray-800 rounded-xl w-full max-w-3xl shadow-2xl overflow-hidden"
                        ...
                        >
                            ...
                            <div className="bg-gray-900/50 py-3 px-6 flex justify-end">
                                <button
                                    className="bg-gray-700 text-gray-300 hover:bg-gray-600 px-4 py-2 rounded-md text-sm font-medium transition-colors"
                                    onClick={() => setIsBackgroundVisible(false)}
                                >
                                    Cerrar
                                </button>
